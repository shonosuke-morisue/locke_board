...
const BASE_CARD_RAW: Array<{ name: string; count: number; content: string }> = [
  ...
  { name: '警戒装置 [1-1]',             count: 2,  content: 'ESPジャマーレベル1\nESPレベル1以下のESP（コンバット・カード他）は使用できない。\nオートマチック・レイガン\n●ESPレベル：1\n●攻撃力は武器火力チェック\n●耐久力：2\n●精神力は機械なので0\n幻覚にはかからない。\n\nESPジャマーは指定レベルを超えた攻撃を受けると破壊され無効になる。\ｎオートマチック・レイガンが破壊されたらこのカードは取り除く。' },
  { name: '警戒装置 [1-2]',             count: 1,  content: 'ESPジャマーレベル1\nESPレベル1以下のESP（コンバット・カード他）は使用できない。\nブラスター\n●ESPレベル：2\n●攻撃力は武器火力チェック\n●耐久力：2\n●精神力は機械なので0\n幻覚にはかからない。\n\nESPジャマーは指定レベルを超えた攻撃を受けると破壊され無効になる。\ｎブラスターが破壊されたらこのカードは取り除く。' },
