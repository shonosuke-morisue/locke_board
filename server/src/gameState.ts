...
const CARD_DEFINITIONS: Array<{ name: string; count: number; content: string }> = [
  { name: '[能力]巡洋艦',                  count: 1,  content: '攻撃時に巡洋艦の支援を得られる。毎回サイコロを2個振り、その武器で相手を攻撃する。通常の攻撃も行える。\nサイコロの目\n2：D弾（ESPレベル6、攻撃力50）\n3：G弾（ESPレベル5、攻撃力30）\n4-6：ビームキャノン（ESPレベル4、攻撃力は武器火力チェック）\n7-11：支援なし\n12：誤爆（このカードを出したプレイヤーをビームキャノンで攻撃）' },
  { name: '[能力]手下',                    count: 2,  content: '手下が1人つく。戦闘時にコンバット・カードを1枚余分にもらえる。\n攻撃時には同調攻撃を行える。ただし、手下が同調するカードはESPレベル2以下に限られる。手下は決していなくならない。' },
  { name: '[能力]ＥＳＰジャマーLv3',       count: 1,  content: 'レベル3\n\nこのカードを出すと、相手はESPレベル3以下のESP（コンバット・カード他）は使えない。ただし、それ以上の攻撃を受けるとジャマーは破壊されたことになり、カードを捨てる。' },
  { name: '[能力]ＥＳＰジャマーLv4',       count: 1,  content: 'レベル4\nこのカードを出すと、相手はESPレベル4以下のESP（コンバット・カード他）は使えない。ただし、それ以上の攻撃を受けるとジャマーは破壊されたことになり、カードを捨てる。' },
  { name: '[能力]ＥＳＰジャマーLv5',       count: 1,  content: 'レベル5\nこのカードを出すと、相手はESPレベル5以下のESP（コンバット・カード他）は使えない。ただし、それ以上の攻撃を受けるとジャマーは破壊されたことになり、カードを捨てる。' },
  { name: '[能力]ＥＳＰフィールドLv3',     count: 1,  content: 'レベル3\nESPレベル3までのESPが使用可能となる（ESP能力と同じように考える）。このカードはいつまでも使えるが、戦闘でこのレベルを超える攻撃を受けると破壊されたことになり、カードを捨てる。' },
  { name: '[能力]ＥＳＰフィールドLv4',     count: 1,  content: 'レベル4\nESPレベル4までのESPが使用可能となる（ESP能力と同じように考える）。このカードはいつまでも使えるが、戦闘でこのレベルを超える攻撃を受けると破壊されたことになり、カードを捨てる。' },
  { name: '[能力]ＥＳＰフィールドLv5',     count: 1,  content: 'レベル5\n\nESPレベル5までのESPが使用可能となる（ESP能力と同じように考える）。このカードはいつまでも使えるが、戦闘でこのレベルを超える攻撃を受けると破壊されたことになり、カードを捨てる。' },
  { name: '[能力]エネルギースーツ',        count: 1,  content: 'これを着ていると、相手は全ての攻撃をESPチェック（サイコロ2個でESP能力レベル以下を出す）しなければならない。チェックに成功すると通常通りだが、失敗するとその攻撃は、攻撃をしかけたプレイヤーに向けられる。このカードがなくなることはないが、他のスーツと重ねて着ることはできない。' },
  { name: '[能力]個人用パワードスーツLv4', count: 1,  content: 'ESPレベル4のシールド（防御）をしていることになる。このカードはいつでも使えるが、戦闘でこのレベルを超える攻撃を受けると破壊されたことになり、カードを捨てる。なお、スーツ類は2着以上重ねて着ることはできない。' },
  { name: '[能力]個人用パワードスーツLv5', count: 1,  content: 'ESPレベル5のシールド（防御）をしていることになる。このカードはいつでも使えるが、戦闘でこのレベルを超える攻撃を受けると破壊されたことになり、カードを捨てる。なお、スーツ類は2着以上重ねて着ることはできない。' },
  { name: '[能力]ニケ',                    count: 1,  content: '戦闘時にこのカードを出し、各ラウンドごとに使用できるかチェックを行う。サイコロを2個振り、自分の精神力以下を出すと使用できる。その代わりそのラウンドは通常の攻撃をできない。\nニケの攻撃は避けられない。攻撃力は20。逆に攻撃を受けるとニケは防御できない。耐久力は10。\n精神力チェックに失敗するとニケは使用できないが通常の攻撃はできる。また、サイコロの目が11、12だったラウンドは、失神して何もできない。ニケの耐久力は回復せず、0になると破壊される。' },
  { name: '[能力]亜空間フィールド',        count: 1,  content: '内容はESPレベル7のテレポートと同じ。サイコロを2個振る。[使い捨てカード]\nサイコロの目\n2-6：ESPレベル7のテレポートを出したのと同じ。\n7-9：失敗。このカードは捨て、コンバット・カードを使う。\n10-12：原因不明の高周波に襲われる。このラウンドは何もできない。' },
  { name: '[能力]ＥＳＰコントローラー',    count: 1,  content: '同じ場所にいるプレイヤーをコントロールできる。自分の順番に相手を指名してこのカードを出す。相手はサイコロを2個振り、自分の精神力以下を出せばコントロールされた相手は同じ場所にいる限り指示通りに動かなくてはならない。ただし毎回自分の番にサイコロを1個振り、1を出せばコントローラーを破壊し、コントロールより脱出できる。その時はこのカードを捨てる。\nコントロールしているプレイヤーはいつでもコントロールをやめられる。同時に2人はコントロールできない。' },
  { name: '[能力]エネルギー吸収ボールLv3', count: 1,  content: 'レベル3\ｎESPレベル3のエネルギー吸収ボールを作れる。\nこのカードは防御カードの代わりに使う。攻撃をかけた相手は、サイコロを2個振って自分のESP能力レベル以下を出さないとエネルギーを吸収されてしまう。\nその場合は、さらにサイコロを1個振り、目の数のラウンドの間、気を失って何もできない（戦闘が終了すれば治る）。エネルギーを吸収できなくても防御にはなる。このカードは1度出すと、その先頭が終わるかレベルを超える攻撃を受けると捨てなくてはならない。' },
  { name: '[能力]エネルギー吸収ボールLv4', count: 1,  content: 'レベル4\ｎESPレベル4のエネルギー吸収ボールを作れる。\nこのカードは防御カードの代わりに使う。攻撃をかけた相手は、サイコロを2個振って自分のESP能力レベル以下を出さないとエネルギーを吸収されてしまう。\nその場合は、さらにサイコロを1個振り、目の数のラウンドの間、気を失って何もできない（戦闘が終了すれば治る）。エネルギーを吸収できなくても防御にはなる。このカードは1度出すと、その先頭が終わるかレベルを超える攻撃を受けると捨てなくてはならない。' },
  { name: '[能力]エネルギー吸収ボールLv5', count: 1,  content: 'レベル5\ｎESPレベル5のエネルギー吸収ボールを作れる。\nこのカードは防御カードの代わりに使う。攻撃をかけた相手は、サイコロを2個振って自分のESP能力レベル以下を出さないとエネルギーを吸収されてしまう。\nその場合は、さらにサイコロを1個振り、目の数のラウンドの間、気を失って何もできない（戦闘が終了すれば治る）。エネルギーを吸収できなくても防御にはなる。このカードは1度出すと、その先頭が終わるかレベルを超える攻撃を受けると捨てなくてはならない。' },
  { name: '[能力]クローン',                count: 3,  content: '戦闘で死亡しても、このカードを出せば次の回に再び登場できる。第1部では惑星の宇宙工から（Evillシルエットは盤外）、第2部は基地外周から登場する。\n[カード]' },
  { name: '[能力]ジオイド弾',              count: 1,  content: '攻撃カードの代わりに出してサイコロを2個振る。[使い捨てカード]\nサイコロの目\n2-4：ジオイド弾（ESPレベル7、攻撃力100）を使える。通常の攻撃はできない。\n5-9：失敗。このカードは捨てる。通常の攻撃を行う。\n10-12：原因不明の高周波に襲われる。このラウンドは何もできない。' },
  { name: '[能力]変身',                    count: 1,  content: 'このカードを出すと、シルエット・カードを別のものと変更できる。\n[使い捨てカード]' },
  { name: '[能力]ラフノールの鏡Lv5',       count: 1,  content: 'レベル5\nESPレベル5のシールド（防御）とテレポートの両方を持つ。相手の攻撃を防ぐと同時にテレポートに入る。防御カードと同じように使う。\n[使い捨てカード]' },
  { name: '[能力]ラフノールの鏡Lv6',       count: 1,  content: 'レベル6\nESPレベル6のシールド（防御）とテレポートの両方を持つ。相手の攻撃を防ぐと同時にテレポートに入る。防御カードと同じように使う。\n[使い捨てカード]' },
  { name: '[能力]ラフノールの鏡Lv7',       count: 1,  content: 'レベル7\nESPレベル7のシールド（防御）とテレポートの両方を持つ。相手の攻撃を防ぐと同時にテレポートに入る。防御カードと同じように使う。\n[使い捨てカード]' },
  { name: '開拓地',                        count: 2,  content: '（何もなし）' },
  { name: '歓楽街',                        count: 2,  content: '（何もなし）' },
  { name: '工業地域',                      count: 2,  content: '（何もなし）' },
  { name: '住宅街',                        count: 2,  content: '（何もなし）' },
  { name: 'スラム街',                      count: 2,  content: '（何もなし）' },
  { name: '宇宙港',                        count: 6,  content: '次の回に別の宇宙港へ行ける。このカードは惑星ボックスに表にして置く。' },
  { name: '逮捕',                          count: 4,  content: '逮捕され刑務所に行く（コマはこのボックスに置いたまま）。\n次回から刑務所を出るためのチェックを行う。\n（刑務所チャート参照）' },
  { name: '戦闘発生',                      count: 10, content: 'ランダム戦闘チャートでチェックを行い、何が出てくるかを決める。' },
  { name: 'トラップ',                      count: 3,  content: 'トラップ・チェックを行い指示に従う。\n（トラップ・チャート参照）' },
  { name: '情報入手',                      count: 13, content: 'このカードは自分の手元に表にして置く。\n3枚集めると秘密基地を発見したことになる。' },
  { name: '自分の正体露顕',                count: 2,  content: '自分のキャラクター・カードを全員に公開しなければならない。' },
  { name: '他人の正体判明',                count: 4,  content: '誰か1人のキャラクター・カードを見ることができる（このカードを引いた人のみ）。' },
];
